    ...
    sg.Frame(
        ...
        layout=[
            [
                ...
                sg.Drop(
                    values=["TI", "ST"], default_value="TI", key="-PART-", font=FONT
                ),
                sg.Text("Board", font=FONT),
                sg.Drop(
                    values=["V1", "V2"], default_value="V1", key="-BOARD-", font=FONT
                ),
            ],
            [
                sg.Text(
            ...
            [
                sg.Text("Timer", font=FONT),
                sg.ProgressBar(
                    100,
                    orientation="h",
                    key="-PROGRESS-",
                    bar_color=(sg.theme_background_color(), "green"),
                    size=(20, 20),
                    expand_x=True,
                ),
            ],
